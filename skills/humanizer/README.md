...
```bash
mkdir -p $STRATA_HOME/skills
git clone https://github.com/blader/humanizer.git $STRATA_HOME/skills/humanizer
```
...
```bash
mkdir -p $STRATA_HOME/skills/humanizer
cp SKILL.md $STRATA_HOME/skills/humanizer/
```
