...
If the problem statement is fuzzy or has unresolved decision branches, walk it down with inline clarifying questions first (one at a time). Hammock then contemplates a sharper question. Skip that pre-step when the problem statement is already concrete.
