...
description: |
  ...
  connections. Use when working with .canvas files, creating visual canvases, mind
  maps, flowcharts, or when the user mentions Canvas files in Obsidian.
  Manual: invoke when working with Obsidian vault files, wikilinks, canvas files,
  or Bases database files.
allowed-tools:
  - Read
  - Write
  - Edit
...
<details>
<summary>Layout Guidelines</summary>
